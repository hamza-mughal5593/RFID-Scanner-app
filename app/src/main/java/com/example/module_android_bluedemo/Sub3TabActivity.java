...
public class Sub3TabActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            File f = new File(getCacheDir()+"/zimska.csv");
            if (!f.exists()) try {

                InputStream is = getAssets().open("zimska.csv");
...
//            String csvfileString = this.getApplicationInfo().dataDir + File.separatorChar + "zimska.csv";
            File csvfile = new File("//android_asset/zimska.csv");
//            File csvfile = new File(getResources().getAssets().open(""));
